...
@Composable
fun DialogSearch(
    dialogState: MutableState<Boolean>, //for close or open AlertDialog
    onSubmit: (String) -> Unit      // for get String from textField
) {
    //state for textFild
    ...
    AlertDialog(onDismissRequest = {
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            Text(text = "Enter name of the city")
            OutlinedTextField(value = dialogText.value, onValueChange = {
                dialogText.value = it
            })
        }
    })
